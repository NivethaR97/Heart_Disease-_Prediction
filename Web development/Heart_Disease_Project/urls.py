"""Heart_Disease_Project URL Configuration
...
from heartdiseaseapp import views
from django.conf.urls import url,include

urlpatterns = [
    path('admin/', admin.site.urls),
    path('/',include('heartdiseaseapp.urls',namespace='heartdiseaseapp')),
    #path('', views.FileUploadView.as_view(), name = 'image_upload'),
    #path('whats', views.WhatsappAnalaysis.as_view(), name = 'whats'),
    path('', views.dataUploadView.as_view(), name= 'heart'),
